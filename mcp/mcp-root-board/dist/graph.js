...
exports.parseMermaidGraph = parseMermaidGraph;
exports.findSubgraphs = findSubgraphs;
exports.analyzeGraph = analyzeGraph;
exports.extractMermaidBlock = extractMermaidBlock;
/**
 ...
 * Soft edge: `.->` or `-.->` or `-.->`
 */
function parseMermaidGraph(mermaid) {
 ...
 */
function findSubgraphs(nodes, edges) {
    if (nodes.length === 0) {
        return [];
    }
